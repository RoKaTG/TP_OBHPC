...
void run_benchmark(const ascii *title, f64 (*kernel)(f64 *restrict, f64 *restrict, u64), u64 n, u64 r);
...
int main(int argc, char **argv) {
  ...
  run_benchmark("L1 - BASE", dotprod_base, n_L1, r);
  run_benchmark("L2 - BASE", dotprod_base, n_L2, r);
  run_benchmark("L3 - BASE", dotprod_base, n_L3, r);

  run_benchmark("L1 - UNROLL4", dotprod_unroll4, n_L1, r);
  run_benchmark("L2 - UNROLL4", dotprod_unroll4, n_L2, r);
  run_benchmark("L3 - UNROLL4", dotprod_unroll4, n_L3, r);

  run_benchmark("L1 - UNROLL8", dotprod_unroll8, n_L1, r);
  run_benchmark("L2 - UNROLL8", dotprod_unroll8, n_L2, r);
  run_benchmark("L3 - UNROLL8", dotprod_unroll8, n_L3, r);

  run_benchmark("L1 - CBLAS", dotprod_cblas, n_L1, r);
  run_benchmark("L2 - CBLAS", dotprod_cblas, n_L2, r);
  run_benchmark("L3 - CBLAS", dotprod_cblas, n_L3, r);

  run_benchmark("L1 - OPENMP", dotprod_openmp, n_L1, r);
  run_benchmark("L2 - OPENMP", dotprod_openmp, n_L2, r);
  run_benchmark("L3 - OPENMP", dotprod_openmp, n_L3, r);
