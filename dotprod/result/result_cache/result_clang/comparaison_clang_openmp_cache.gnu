...
set output 'plot/comparison_clang_dotprod_openmp_cache.png'

set title "Performance Comparison for Different Optimization Flags & Caches for dotprod's openmp"
set ylabel "MiB/s"
...
plot 'openmp/data_openmp.dat' using 2:3:xtic(1) title 'O3', \
     '' using 4:5 title 'O2', \
     '' using 6:7 title 'O1', \
