...
set output 'comparison_clang_dotprod.png'

set title "Performance Comparison for Different Functions and Optimization Flags for dotprod compilation using CLANG"
set ylabel "MiB/s"
