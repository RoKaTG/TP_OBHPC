...
set output 'comparison_clang_reduc.png'

set title "Performance Comparison for Different Functions and Optimization Flags for reduc compilation using CLANG"
set ylabel "MiB/s"
